...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-page border-b border-navbar-line px-8 py-4 flex justify-center md:justify-between items-center">
      <Link to="/" className="hidden md:block text-navbar-text font-script text-2xl">emma te miha.</Link>

      <ul className="flex gap-12 md:gap-12 justify-center items-center">
      ...
      <div className="text-navbar-text text-right text-sm hidden md:block">
        NZT {formattedTime}
      </div>
    </nav>
  )
