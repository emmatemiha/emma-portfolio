...
export default function Footer() {
  return (
    <footer className="border-t border-accent-border px-8 py-8 mt-16">
      <div className="flex justify-center gap-4 mb-4">
        <a href="https://github.com/emmatemiha" target="_blank" rel="noopener noreferrer"
          className="flex items-center justify-center w-10 h-10 bg-white border border-accent-border rounded-full hover:scale-110 hover:bg-accent/40 transition-all duration-300 transform-gpu">
      ...
      <p className="text-center text-xs text-roles">
